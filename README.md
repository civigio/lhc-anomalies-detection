...
pT , pseudorapidity η, and azimuthal angle ϕ measurements, with weights that tune the reciprocal
relevance of each observable. For every model, the performance is presented in terms of AUC and
TPR@FPR(1e−5) and compared with other studies used as benchmarks.
